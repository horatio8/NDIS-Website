...
// Donate amount tiers and Stripe Payment Links live in donate-config.js
// so they can be shared with the embeddable widget (embed.html).
const { LADDER, STRIPE_LINKS } = window.DONATE_CONFIG;
